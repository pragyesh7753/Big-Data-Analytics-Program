# -------------------Factors---------------------------
fac = factor(c("Male", "Female","Male", "Female","Male", "Female","Male", "Female","Male", "Female"))
print(fac)
...
A <- c(11,20,6,4,56)
barplot(A, xlab="X-axis", ylab = "Y-axis", main = "Horizontal Bar-chart", horiz = TRUE)
...
barplot(A, names.arg = B,
        ...
        cex.main=1.5,    # Main title size. / cex means character expansion
        cex.lab = 1.2,    # X& Y axis label size
